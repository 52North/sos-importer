...
public class DefaultCsvCollector extends CollectorSkeleton implements Collector {
    ...
    public DefaultCsvCollector() {
        //        // TODO move to sample based collector
    ...
    private InsertObservation[] getInsertObservationsForOneLine(String[] line) {
    ...
    private InsertObservation getInsertObservationForMeasuredValue(int measureValueColumn, String[] line)
    ...
    //  final String lineToParse = configuration.restoreLine(values);
    ...
    //  final String timestampInformation = configuration.restoreLine(values);
    ...
    //  return sampleIdPattern.matcher(configuration.restoreLine(values)).matches();
    //}
