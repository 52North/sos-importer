...
import org.x52North.sensorweb.sos.importer.x05.NumberDocument.Number;
    ...
    public void handleModel(final Step6bSpecialModel stepModel,
        ...
        if (sensorXB == null) {
            ...
            if (sensor.isGenerated()) {
                ...
                final org.x52North.sensorweb.sos.importer.x05.URIDocument.URI uriXB = sensorGRT.addNewURI();
